import type { TemplateSchemaJson, AiInsightPayload } from '../../shared/types.js';
/**
 ...
 */
export declare function generateInsightsLlmMock(template: TemplateSchemaJson, answers: Record<string, unknown>): AiInsightPayload;
